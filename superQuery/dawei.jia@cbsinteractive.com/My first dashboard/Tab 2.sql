...
where day_dt between '2020-06-27' and '2020-07-20' and (episode_nm like "Match Replay%" or episode_nm like "NWSL%" or episode_nm = 'cbsnwsl') and site_country_cd = 'US' and content_type_cd = 'LIVE'
